                ...
                >
                  ...
                  >
                    <Box sx={{ display: "flex", flexDirection: "column" }}>
                      ...
                      >
                        {item?.orderItems.map((order, orderId) => (
                          <span key={orderId}> {order.product.title},</span>
                        ))}
                      </Typography>
                    ...
                    <Chip
                      ...
                      color={
                        item.orderStatus === "PENDING"
                          ? "info" : item.orderStatus === "DELIVERED"
                            ? "success" : "secondary"
                      }
                  ...
                  >
                    <Button>
                      {item.orderStatus === "PENDING" ? "PENDING"
                        : item.orderStatus === "PLACED" ? "CONFIRMED"
                          : item.orderStatus === "CONFIRMED" ? "SHIPPED" : "DELIVERED"
                      }
                    </Button>
                    <div>
                      <Button
